  ...
  <div className="dashboard-layout">
   <aside className="sidebar">
    <div className="sidebar-brand">
     ...
     <span className="brand-name">Nhà Xe DungVM</span>
    </div>
        ...
        {trips.map((trip) => (
         <div key={trip.id} className="data-card" id={`trip_card_${trip.id}`}>
          <div className="data-card-details">
           ...
           <div className="data-card-title" style={{ marginTop: "4px" }}>
            {trip.from} ➔ {trip.to}
           </div>
           <div className="data-card-meta">
            <div className="meta-item">
            ...
            <div className="meta-item">
             <span>
              Khởi hành: <strong>{trip.departureTime}</strong> (Đến:{" "}
              {trip.arrivalTime})
             </span>
            </div>
            <div className="meta-item">
             <span>
              Giá vé: <strong>{formatPrice(trip.price)}</strong>
             </span>
            </div>
            <div className="meta-item">
            ...
            <div className="meta-item">
             <span>
              Ghế trống: {trip.availableSeats}/{trip.totalSeats}
             </span>
            </div>
           </div>
          </div>
         ...
         >
          <div className="data-card-details">
           <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            <span
             className={`badge ${ticket.status === "completed" ? "success" : ticket.status === "confirmed" ? "primary" : ticket.status === "cancelled" ? "danger" : "warning"}`}
            >
           ...
           >
            Tuyến: {ticket.from} ➔ {ticket.to} ({ticket.company} -{" "}
            {ticket.busNumber})
           </div>
           <div className="data-card-meta">
            <div className="meta-item">
             <span>
              Khách hàng: <strong>{ticket.passengerName}</strong> (
              {ticket.passengerPhone})
             </span>
            </div>
            <div className="meta-item">
             <span>
              Ghế: <strong>{ticket.seats.join(", ")}</strong>
             </span>
            </div>
            <div className="meta-item">
             <span>
              Tổng tiền: <strong>{formatPrice(ticket.totalPrice)}</strong>
             </span>
            </div>
           </div>
          </div>
          ...
          {ticket.status !== "cancelled" && (
           <button
            className={`boarding-btn ${ticket.status === "completed" ? "completed" : ""}`}
            onClick={() => onConfirmBoarding(ticket.id)}
            disabled={ticket.status === "completed"}
           >
            <CheckSquare size={16} />
            <span>
             {ticket.status === "completed" ? "Đã lên xe" : "Xác nhận lên xe"}
            </span>
           </button>
          )}
         </div>
     ...
     <div className="modal-content">
      <div className="modal-header">
       <h3 className="modal-title">
        {editingRoute ? "Cập nhật Tuyến đường" : "Tạo Tuyến chạy mới"}
       </h3>
       <button className="modal-close" onClick={onRouteModalClose}>
        <X size={18} />
       </button>
      </div>
      <div className="modal-body">
       <div className="form-group">
        ...
        <input
         ...
         value={routeFrom}
         onChange={(e) => onRouteFormChange("from", e.target.value)}
         id="modal_route_from"
        />
       </div>
       <div className="form-group">
        ...
        <input
         ...
         value={routeTo}
         onChange={(e) => onRouteFormChange("to", e.target.value)}
         id="modal_route_to"
        />
       </div>
       <div className="form-group">
        ...
        <input
         ...
         value={routeDistance}
         onChange={(e) => onRouteFormChange("distance", e.target.value)}
         id="modal_route_distance"
        />
       </div>
       <div className="form-group">
        ...
        <input
         ...
         value={routeDuration}
         onChange={(e) => onRouteFormChange("duration", e.target.value)}
         id="modal_route_duration"
        />
       </div>
      </div>
      <div className="modal-footer">
       <button className="btn-secondary" onClick={onRouteModalClose}>
        Hủy
       </button>
       <button
        className="action-btn"
   ...
   {tripModalVisible && (
    <div className="modal-overlay">
     <div className="modal-content" style={{ maxWidth: "580px" }}>
      <div className="modal-header">
       <h3 className="modal-title">
        {editingTrip ? "Cập nhật Chuyến chạy" : "Thêm Chuyến chạy mới"}
       </h3>
       <button className="modal-close" onClick={onTripModalClose}>
        <X size={18} />
       </button>
      </div>
      <div className="modal-body">
       <div className="form-group">
        ...
        <select
         ...
         value={tripRouteId}
         onChange={(e) => onTripFormChange("routeId", e.target.value)}
       ...
       >
        <div className="form-group">
         ...
         <input
          ...
          className="form-input"
          value={tripDate}
          onChange={(e) => onTripFormChange("date", e.target.value)}
          id="modal_trip_date"
         />
        </div>
        <div className="form-group">
         ...
         <input
          ...
          value={tripDepTime}
          onChange={(e) => onTripFormChange("depTime", e.target.value)}
          id="modal_trip_dep_time"
         />
        </div>
        <div className="form-group">
         ...
         <input
          ...
          value={tripArrTime}
          onChange={(e) => onTripFormChange("arrTime", e.target.value)}
          id="modal_trip_arr_time"
         />
        </div>
       </div>
       ...
       >
        <div className="form-group">
         ...
         <input
          ...
          value={tripPrice}
          onChange={(e) => onTripFormChange("price", e.target.value)}
          id="modal_trip_price"
         />
        </div>
        <div className="form-group">
         ...
         <input
          ...
          value={tripBusNumber}
          onChange={(e) => onTripFormChange("busNumber", e.target.value)}
          id="modal_trip_bus_number"
         />
        </div>
       </div>
       ...
       >
        <div className="form-group">
         ...
         <input
          type="text"
          className="form-input"
          placeholder="VD: Limousine 34 chỗ"
          value={tripBusType}
          onChange={(e) => onTripFormChange("busType", e.target.value)}
          id="modal_trip_bus_type"
         />
        </div>
        <div className="form-group">
         ...
         <input
          type="text"
          className="form-input"
          placeholder="VD: Xe Vân Anh"
          value={tripCompany}
          onChange={(e) => onTripFormChange("company", e.target.value)}
          id="modal_trip_company"
         />
        </div>
       </div>
      </div>
      <div className="modal-footer">
       <button className="btn-secondary" onClick={onTripModalClose}>
        Hủy
       </button>
       <button className="action-btn" onClick={onSaveTrip} id="modal_trip_save">
        Lưu thông tin
       </button>
      </div>
     </div>
