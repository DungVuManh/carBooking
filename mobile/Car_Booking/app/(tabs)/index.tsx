     ...
     <View style={styles.locationContainer}>
      ...
      >
       ...
       <View style={styles.locationTexts}>
        ...
        <Text
         style={[styles.locationValue, !from && styles.placeholder]}
         numberOfLines={1}
        >
         {from || "Chọn điểm đi"}
        </Text>
      ...
      >
       <View
        style={[styles.locationDot, { backgroundColor: COLORS.success }]}
       />
       <View style={styles.locationTexts}>
        <Text style={styles.locationLabel}>Điểm đến</Text>
        <Text
         style={[styles.locationValue, !to && styles.placeholder]}
         numberOfLines={1}
        >
         {to || "Chọn điểm đến"}
        </Text>
      ...
      <View style={styles.modalHeader}>
       <View style={{ flex: 1 }}>
        ...
        <Text style={styles.modalSub}>
         Chọn từ danh sách tuyến đường có sẵn
        </Text>
       </View>
      </View>
   ...
   >
    ...
    >
     <TouchableOpacity activeOpacity={1} style={styles.modalSheet}>
      ...
      >
       <View
        style={[styles.pickerIconBox, { backgroundColor: COLORS.accentLight }]}
       >
        <Ionicons name="time" size={16} color={COLORS.accent} />
       </View>
       <Text style={[styles.pickerItemText, { flex: 1 }]}>
