/**
 * Mock data cho ứng dụng Bus Booking.
...
/**
 * Tạo layout ghế cho xe Limousine 34 chỗ (2 tầng, mỗi tầng 17 ghế)
 * Hàng A, B, C, D - mỗi hàng 4 ghế (2 trái, lối đi, 2 phải)
 */
export const generateSeats = (tripId: string): Seat[] => {
  // Các ghế đã được đặt sẵn (giả lập)
  ...
  const cols = [1, 2, 3, 4]; // 2 cột trái + 2 cột phải
...
export const MOCK_TICKETS: Ticket[] = [
  ...
  },
  {
    ...
    status: 'pending',
    paymentMethod: 'qr',
    bookedAt: '2025-07-12T09:15:00.000Z',
    busType: 'Giường nằm VIP 34 chỗ',
    busNumber: '29D - 567.89',
    company: 'Xe Sapa Express',
  },
  {
    ...
    status: 'completed',
    paymentMethod: 'qr',
    bookedAt: '2025-06-10T11:00:00.000Z',
    busType: 'Xe ghế ngồi 45 chỗ',
    busNumber: '14C - 789.01',
    company: 'Xe Hoàng Long',
  },
...
export const MOCK_CHAT_MESSAGES: ChatMessage[] = [
  ...
  },
  {
    ...
    content: 'Cho tôi hỏi chuyến xe 06:00 Hà Nội - Hải Phòng ngày 20/7 còn ghế không?',
    timestamp: '2025-07-12T09:01:00.000Z',
    isRead: true,
  },
  {
    id: 'msg_003',
  ...
  },
  {
    ...
    timestamp: '2025-07-12T09:03:00.000Z',
    isRead: true,
  },
  {
    id: 'msg_005',
...
export const MOCK_NOTIFICATIONS: Notification[] = [
  {
    ...
    body: 'Chuyến xe Hà Nội → Hải Phòng của bạn xuất phát lúc 06:00 ngày 20/07. Vui lòng có mặt trước 15 phút!',
    type: 'reminder',
    isRead: false,
  ...
  },
  {
    ...
    body: 'Đặt vé chuyến xe 06:00 Hà Nội → Hải Phòng ngày 20/07 thành công. Mã vé: #TKT001',
    type: 'booking',
    isRead: false,
  ...
  {
    id: 'notif_003',
    title: '🎁 Ưu đãi hè 2025',
    body: 'Giảm 20% cho tất cả chuyến xe từ 01/08 - 31/08/2025. Nhập mã HE2025 khi đặt vé!',
    type: 'promotion',
    isRead: true,
  ...
  },
  {
    id: 'notif_004',
    title: '⏰ Nhắc nhở chuyến đi',
    body: 'Chuyến xe Hà Nội → Lào Cai xuất phát lúc 22:00 ngày 01/08. Hãy chuẩn bị hành lý!',
    type: 'reminder',
    isRead: true,
    createdAt: '2025-07-31T16:00:00.000Z',
    tripId: 'trip_005',
  },
  {
    id: 'notif_005',
